        ...
        const fazerJogadaMaquina = () =>
        {
            ...
            else if (nivelDificuldade == "dificil")
            {
                ...
                else
                {
                    //Possibilidades horizontais
                    if ((campoA.classList.contains("x") && campoB.classList.contains("x") && campoC.classList.contains("white")) ||
                            (campoA.classList.contains("o") && campoB.classList.contains("o") && campoC.classList.contains("white")) ) 
                    {
                        const novaImg = document.createElement("span")
                        novaImg.innerHTML = `radio_button_unchecked` // ícone o
                        novaImg.classList.add("material-icons-outlined")
                    ...
                    || (campoA.classList.contains("o") && campoC.classList.contains("o") && campoB.classList.contains("white"))) 
                    {
                        const novaImg = document.createElement("span")
                        novaImg.innerHTML = `radio_button_unchecked` // ícone o
                        novaImg.classList.add("material-icons-outlined")
                    ...
                    || (campoB.classList.contains("o") && campoC.classList.contains("o") && campoA.classList.contains("white"))) 
                    {
                        const novaImg = document.createElement("span")
                        novaImg.innerHTML = `radio_button_unchecked` // ícone o
                        novaImg.classList.add("material-icons-outlined")
                    ...
                    || (campoD.classList.contains("o") && campoE.classList.contains("o") && campoF.classList.contains("white"))) 
                    {
                        const novaImg = document.createElement("span")
                        novaImg.innerHTML = `radio_button_unchecked` // ícone o
                        novaImg.classList.add("material-icons-outlined")
                    ...
                    || (campoD.classList.contains("o") && campoF.classList.contains("o") && campoE.classList.contains("white"))) 
                    {
                        const novaImg = document.createElement("span")
                        novaImg.innerHTML = `radio_button_unchecked` // ícone o
                        novaImg.classList.add("material-icons-outlined")
                    ...
                    || (campoE.classList.contains("o") && campoF.classList.contains("o") && campoD.classList.contains("white"))) 
                    {
                        const novaImg = document.createElement("span")
                        novaImg.innerHTML = `radio_button_unchecked` // ícone o
                        novaImg.classList.add("material-icons-outlined")
                    ...
                    || (campoG.classList.contains("o") && campoH.classList.contains("o") && campoI.classList.contains("white"))) 
                    {
                        const novaImg = document.createElement("span")
                        novaImg.innerHTML = `radio_button_unchecked` // ícone o
                        novaImg.classList.add("material-icons-outlined")
                    ...
                    || (campoG.classList.contains("o") && campoI.classList.contains("o") && campoH.classList.contains("white"))) 
                    {
                        const novaImg = document.createElement("span")
                        novaImg.innerHTML = `radio_button_unchecked` // ícone o
                        novaImg.classList.add("material-icons-outlined")
                    ...
                    || (campoH.classList.contains("o") && campoI.classList.contains("o") && campoG.classList.contains("white"))) 
                    {
                        const novaImg = document.createElement("span")
                        novaImg.innerHTML = `radio_button_unchecked` // ícone o
                        novaImg.classList.add("material-icons-outlined")
                    ...
                    || (campoA.classList.contains("o") && campoD.classList.contains("o") && campoG.classList.contains("white"))) 
                    {
                        const novaImg = document.createElement("span")
                        novaImg.innerHTML = `radio_button_unchecked` // ícone o
                        novaImg.classList.add("material-icons-outlined")
                    ...
                    || (campoA.classList.contains("o") && campoG.classList.contains("o") && campoD.classList.contains("white"))) 
                    {
                        const novaImg = document.createElement("span")
                        novaImg.innerHTML = `radio_button_unchecked` // ícone o
                        novaImg.classList.add("material-icons-outlined")
                    ...
                    || (campoD.classList.contains("o") && campoG.classList.contains("o") && campoA.classList.contains("white"))) 
                    {
                        const novaImg = document.createElement("span")
                        novaImg.innerHTML = `radio_button_unchecked` // ícone o
                        novaImg.classList.add("material-icons-outlined")
                    ...
                    || (campoB.classList.contains("o") && campoE.classList.contains("o") && campoH.classList.contains("white"))) 
                    {
                        const novaImg = document.createElement("span")
                        novaImg.innerHTML = `radio_button_unchecked` // ícone o
                        novaImg.classList.add("material-icons-outlined")
                    ...
                    || (campoB.classList.contains("o") && campoH.classList.contains("o") && campoE.classList.contains("white"))) 
                    {
                        const novaImg = document.createElement("span")
                        novaImg.innerHTML = `radio_button_unchecked` // ícone o
                        novaImg.classList.add("material-icons-outlined")
                    ...
                    || (campoE.classList.contains("o") && campoH.classList.contains("o") && campoB.classList.contains("white"))) 
                    {
                        const novaImg = document.createElement("span")
                        novaImg.innerHTML = `radio_button_unchecked` // ícone o
                        novaImg.classList.add("material-icons-outlined")
                    ...
                    || (campoC.classList.contains("o") && campoF.classList.contains("o") && campoI.classList.contains("white"))) 
                    {
                        const novaImg = document.createElement("span")
                        novaImg.innerHTML = `radio_button_unchecked` // ícone o
                        novaImg.classList.add("material-icons-outlined")
                    ...
                    || (campoC.classList.contains("o") && campoI.classList.contains("o") && campoF.classList.contains("white"))) 
                    {
                        const novaImg = document.createElement("span")
                        novaImg.innerHTML = `radio_button_unchecked` // ícone o
                        novaImg.classList.add("material-icons-outlined")
                    ...
                    || (campoF.classList.contains("o") && campoI.classList.contains("o") && campoC.classList.contains("white"))) 
                    {
                        const novaImg = document.createElement("span")
                        novaImg.innerHTML = `radio_button_unchecked` // ícone o
                        novaImg.classList.add("material-icons-outlined")
                    ...
                    || (campoA.classList.contains("o") && campoE.classList.contains("o") && campoI.classList.contains("white"))) 
                    {
                        const novaImg = document.createElement("span")
                        novaImg.innerHTML = `radio_button_unchecked` // ícone o
                        novaImg.classList.add("material-icons-outlined")
                    ...
                    || (campoA.classList.contains("o") && campoI.classList.contains("o") && campoE.classList.contains("white"))) 
                    {
                        const novaImg = document.createElement("span")
                        novaImg.innerHTML = `radio_button_unchecked` // ícone o
                        novaImg.classList.add("material-icons-outlined")
                    ...
                    || (campoE.classList.contains("o") && campoI.classList.contains("o") && campoA.classList.contains("white"))) 
                    {
                        const novaImg = document.createElement("span")
                        novaImg.innerHTML = `radio_button_unchecked` // ícone o
                        novaImg.classList.add("material-icons-outlined")
                    ...
                    || (campoC.classList.contains("o") && campoE.classList.contains("o") && campoG.classList.contains("white"))) 
                    {
                        const novaImg = document.createElement("span")
                        novaImg.innerHTML = `radio_button_unchecked` // ícone o
                        novaImg.classList.add("material-icons-outlined")
                    ...
                    || (campoC.classList.contains("o") && campoG.classList.contains("o") && campoE.classList.contains("white"))) 
                    {
                        const novaImg = document.createElement("span")
                        novaImg.innerHTML = `radio_button_unchecked` // ícone o
                        novaImg.classList.add("material-icons-outlined")
                    ...
                    || (campoE.classList.contains("o") && campoG.classList.contains("o") && campoC.classList.contains("white"))) 
                    {
                        const novaImg = document.createElement("span")
                        novaImg.innerHTML = `radio_button_unchecked` // ícone o
                        novaImg.classList.add("material-icons-outlined")
